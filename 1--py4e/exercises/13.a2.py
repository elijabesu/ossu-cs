...
# Actual data: http://py4e-data.dr-chuck.net/comments_925879.json (Sum ends with 13)
# 
...
# }
# 
# The closest sample code that shows how to parse JSON and extract
# a list is json2.py. You might also want to look at geoxml.py to
# see how to prompt for a URL and retrieve data from a URL.
# 
# Sample Execution
# 
# $ python3 solution.py
...
print("Retrieved " + str(len(data.decode())) + " characters.")
print("Count:", len(owo))
print("Sum:", total)